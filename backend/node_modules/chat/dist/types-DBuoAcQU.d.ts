import { a as ChatElement, C as CardElement, M as ModalElement, S as SelectOptionElement } from './jsx-runtime-Duh4FXOc.js';
...
declare class ThreadImpl<TState = Record<string, unknown>> implements Thread<TState> {
    ...
    private handlePostableObject;
    postEphemeral(user: string | Author, message: AdapterPostableMessage | ChatElement, options: PostEphemeralOptions): Promise<EphemeralMessage | null>;
    reply(target: string | Message, message: AdapterPostableMessage | AsyncIterable<string | StreamChunk | StreamEvent> | ChatElement): Promise<SentMessage>;
    /**
    ...
    startTyping(status?: string): Promise<void>;
    markAsRead(message?: string | Message): Promise<void>;
    /**
...
interface Thread<TState = Record<string, unknown>, TRawMessage = unknown> extends Postable<TState, TRawMessage> {
     ...
     * ```
     */
    reply(target: string | Message<TRawMessage>, message: AdapterPostableMessage | AsyncIterable<string | StreamChunk | StreamEvent> | ChatElement): Promise<SentMessage<TRawMessage>>;
    /**
 ...
 */
type MessageUpdatedHandler<TState = Record<string, unknown>> = (thread: Thread<TState>, message: Message, previousMessage?: Message) => void | Promise<void>;
/**
 ...
 */
interface MessageDeletedEvent<TRawMessage = unknown> {
    /** The adapter that received the event */
    adapter: Adapter;
 ...
 */
type MessageDeletedHandler = (event: MessageDeletedEvent) => void | Promise<void>;
/**
...
interface AppContextEntityBase {
    enterpriseId?: string;
    teamId?: string;
}
interface AppContextChannelEntity extends AppContextEntityBase {
    channelId: string;
    kind: "channel";
}
interface AppContextCanvasEntity extends AppContextEntityBase {
    canvasId: string;
    kind: "canvas";
}
interface AppContextListEntity extends AppContextEntityBase {
    kind: "list";
    listId: string;
}
interface AppContextMessageEntity extends AppContextEntityBase {
    channelId: string;
    kind: "message";
    messageTs: string;
}
interface AppContextUnknownEntity extends AppContextEntityBase {
    kind: "unknown";
    type: string;
    value: unknown;
}
type AppContextEntity = AppContextChannelEntity | AppContextCanvasEntity | AppContextListEntity | AppContextMessageEntity | AppContextUnknownEntity;
...
type AppContextChangedHandler = (event: AppContextChangedEvent) => void | Promise<void>;
...
export { type EmojiMapConfig as $, type Adapter as A, type AppContextChangedEvent as B, type ChatInstance as C, type DirectMessageHandler as D, type EmojiValue as E, type MemberJoinedChannelEvent as F, type StateAdapter as G, type Author as H, type Thread as I, type Channel as J, type Attachment as K, type Logger as L, type MentionHandler as M, type ChannelVisibility as N, type OptionsLoadHandler as O, type PostableObject as P, type PostableObjectContext as Q, type ReactionHandler as R, type SubscribedMessageHandler as S, type TranscriptsApi as T, type UserInfo as U, type StreamChunk as V, type WebhookOptions as W, ThreadHistoryCache as X, type ThreadHistoryConfig as Y, type StreamEvent as Z, type EmojiFormats as _, type ChatConfig as a, type StreamOptions as a$, type WellKnownEmoji as a0, type CustomEmojiMap as a1, type AdapterPostableMessage as a2, type AppContextCanvasEntity as a3, type AppContextChannelEntity as a4, type AppContextEntity as a5, type AppContextEntityBase as a6, type AppContextListEntity as a7, type AppContextMessageEntity as a8, type AppContextUnknownEntity as a9, type LogLevel as aA, type MarkdownTextChunk as aB, type MessageContext as aC, type MessageData as aD, type MessageMetadata as aE, type MessageSubject as aF, type ModalClearResponse as aG, type ModalCloseResponse as aH, type ModalErrorsResponse as aI, type ModalPushResponse as aJ, type ModalUpdateResponse as aK, type OptionsLoadGroup as aL, type PlanUpdateChunk as aM, type PostEphemeralOptions as aN, type Postable as aO, type PostableAst as aP, type PostableCard as aQ, type PostableMarkdown as aR, type PostableMessage as aS, type PostableRaw as aT, type QueueEntry as aU, type RawMessage as aV, type ScheduledMessage as aW, type SentMessage as aX, type SerializedChannel as aY, type SerializedMessage as aZ, type SerializedThread as a_, type AppendInput as aa, type AppendOptions as ab, ChannelImpl as ac, type ChannelInfo as ad, type ConcurrencyConfig as ae, type ConcurrencyStrategy as af, ConsoleLogger as ag, type CountQuery as ah, type DeleteTarget as ai, type DurationString as aj, type Emoji as ak, type EphemeralMessage as al, type FetchDirection as am, type FetchOptions as an, type FetchResult as ao, type FileUpload as ap, type FormattedContent as aq, type IdentityContext as ar, type IdentityResolver as as, type LinkPreview as at, type ListQuery as au, type ListThreadsOptions as av, type ListThreadsResult as aw, type Lock as ax, type LockScope as ay, type LockScopeContext as az, type MessageHandler as b, THREAD_STATE_TTL_MS as b0, type TaskUpdateChunk as b1, ThreadImpl as b2, type ThreadInfo as b3, type ThreadSummary as b4, type TranscriptEntry as b5, type TranscriptRole as b6, type TranscriptsConfig as b7, deriveChannelId as b8, isPostableObject as b9, type MessageUpdatedHandler as c, type MessageDeletedHandler as d, type ActionHandler as e, type ModalSubmitHandler as f, type ModalCloseHandler as g, type SlashCommandHandler as h, type AssistantThreadStartedHandler as i, type AssistantContextChangedHandler as j, type AppHomeOpenedHandler as k, type AppContextChangedHandler as l, type MemberJoinedChannelHandler as m, Message as n, type MessageDeletedEvent as o, type ReactionEvent as p, type ActionEvent as q, type OptionsLoadEvent as r, type OptionsLoadResult as s, type ModalSubmitEvent as t, type ModalResponse as u, type ModalCloseEvent as v, type SlashCommandEvent as w, type AssistantThreadStartedEvent as x, type AssistantContextChangedEvent as y, type AppHomeOpenedEvent as z };
