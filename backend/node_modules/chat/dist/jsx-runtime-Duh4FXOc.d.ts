...
type ModalChild = TextInputElement | DateInputElement | NumberInputElement | SelectElement | ExternalSelectElement | RadioSelectElement | TextElement | FieldsElement;
...
declare function DateInput(options: DateInputOptions): DateInputElement;
...
declare function NumberInput(options: NumberInputOptions): NumberInputElement;
...
type CardJSXProps = CardProps | TextProps | ButtonProps | LinkButtonProps | CardLinkProps | ImageProps | FieldProps | ContainerProps | DividerProps | ModalProps | TextInputProps | DateInputProps | NumberInputProps | SelectProps | ExternalSelectProps | SelectOptionProps | TableProps | ChartProps;
/** Component function type with proper overloads */
type CardComponentFunction = typeof Card | typeof Text | typeof Button | typeof LinkButton | typeof CardLink | typeof Image | typeof Field | typeof Divider | typeof Section | typeof Actions | typeof Fields | typeof Modal | typeof TextInput | typeof DateInput | typeof NumberInput | typeof Select | typeof ExternalSelect | typeof RadioSelect | typeof SelectOption | typeof Table | typeof Chart;
/**
...
type ChatElement = CardJSXElement | CardElement | TextElement | ButtonElement | LinkButtonElement | LinkElement | ImageElement | DividerElement | ActionsElement | SectionElement | FieldsElement | FieldElement | ModalElement | TextInputElement | DateInputElement | NumberInputElement | SelectElement | ExternalSelectElement | SelectOptionElement | RadioSelectElement | TableElement | ChartElement;
...
export { type DateInputProps as $, type ActionsComponent as A, type ButtonComponent as B, type CardElement as C, type DateInputComponent as D, type ExternalSelectComponent as E, type FieldComponent as F, type ButtonStyle as G, type CardJSXElement as H, type ImageComponent as I, type CardJSXProps as J, type CardLinkProps as K, type LinkButtonComponent as L, type ModalElement as M, type NumberInputComponent as N, type CardOptions as O, type CardProps as P, type ChartDataPoint as Q, type RadioSelectComponent as R, type SelectOptionElement as S, type TextComponent as T, type ChartDefinition as U, type ChartOptions as V, type ChartSegment as W, type ChartSeries as X, type ContainerProps as Y, type DateInputElement as Z, type DateInputOptions as _, type ChatElement as a, type DividerElement as a0, type DividerProps as a1, type ExternalSelectElement as a2, type ExternalSelectOptions as a3, type ExternalSelectProps as a4, type FieldElement as a5, type FieldProps as a6, type FieldsElement as a7, type ImageElement as a8, type ImageProps as a9, type TextProps as aA, type TextStyle as aB, type ChartProps as aC, Fragment as aD, JSX as aE, type TableComponent as aF, type TableProps as aG, isCardLinkProps as aH, jsx as aI, jsxDEV as aJ, jsxs as aK, type LinkButtonElement as aa, type LinkButtonOptions as ab, type LinkButtonProps as ac, type LinkElement as ad, type ModalChild as ae, type ModalOptions as af, type ModalProps as ag, type NumberInputElement as ah, type NumberInputOptions as ai, type NumberInputProps as aj, type PieChartDefinition as ak, type RadioSelectElement as al, type RadioSelectOptions as am, type SectionElement as an, type SelectElement as ao, type SelectOptionProps as ap, type SelectOptions as aq, type SelectProps as ar, type SeriesChartDefinition as as, type TableAlignment as at, type TableElement as au, type TableOptions as av, type TextElement as aw, type TextInputElement as ax, type TextInputOptions as ay, type TextInputProps as az, type CardChild as b, type ChartElement as c, type CardComponent as d, type CardLinkComponent as e, type ChartComponent as f, type DividerComponent as g, type FieldsComponent as h, type ModalComponent as i, type SectionComponent as j, type SelectComponent as k, type SelectOptionComponent as l, Table as m, type TextInputComponent as n, cardChildToFallbackText as o, fromReactElement as p, fromReactModalElement as q, isCardElement as r, isJSX as s, isModalElement as t, toCardElement as u, toModalElement as v, type ActionsElement as w, type ButtonElement as x, type ButtonOptions as y, type ButtonProps as z };
