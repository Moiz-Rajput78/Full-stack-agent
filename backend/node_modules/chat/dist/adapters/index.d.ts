...
declare const ADAPTERS: {
    ...
    readonly instagram: {
        readonly description: "Build bots for Instagram Direct with DMs, media, quick replies, reactions, and story replies.";
        readonly env: {
            readonly config: readonly ["apiVersion", "userName"];
            readonly optional: readonly [EnvVar];
            readonly required: readonly [EnvVar, EnvVar, EnvVar, EnvVar];
        };
        readonly factoryExport: "createInstagramAdapter";
        readonly group: "official";
        readonly name: "Instagram";
        readonly packageName: "@chat-adapter/instagram";
        readonly peerDeps: readonly [];
    ...
    readonly notion: {
        readonly description: "Participate in Notion page and block comment discussions via webhooks and the Comments API.";
        readonly env: {
            readonly config: readonly ["apiBaseUrl", "streamingEditIntervalMs", "externalUrlPollDelaysMs"];
            readonly optional: readonly [EnvVar, EnvVar, EnvVar, EnvVar];
            readonly required: readonly [EnvVar, EnvVar];
        };
        readonly factoryExport: "createNotionAdapter";
        readonly group: "official";
        readonly name: "Notion";
        readonly packageName: "@chat-adapter/notion";
        readonly peerDeps: readonly [];
    ...
    readonly telegram: {
        ...
        readonly env: {
            readonly config: readonly ["nativeStreaming", "streamingEditIntervalMs"];
            readonly optional: readonly [EnvVar, EnvVar, EnvVar, EnvVar];
            readonly required: readonly [EnvVar];
        };
    ...
    readonly xchat: {
        readonly description: "Hold encrypted 1:1 and group conversations on XChat with all cryptography handled inside the adapter.";
        readonly env: {
            readonly optional: readonly [EnvVar, EnvVar, EnvVar, EnvVar, EnvVar];
            readonly required: readonly [EnvVar, EnvVar];
        };
        readonly factoryExport: "createXchatAdapter";
        readonly group: "official";
        readonly importPath: "@chat-adapter/x/chat";
        readonly name: "XChat";
        readonly packageName: "@chat-adapter/x";
        readonly peerDeps: readonly ["@xdevplatform/chat-xdk", "@xdevplatform/xdk", "juicebox-sdk"];
        readonly slug: "xchat";
        readonly type: "platform";
    };
    readonly zernio: {
