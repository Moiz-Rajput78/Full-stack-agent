...
export declare function writePinnedKnowledge(store: KnowledgeStorage, options: PinnedToolsOptions, text: string, level?: KnowledgeScopeLevel, metadata?: Record<string, unknown>): Promise<KnowledgeRecord>;
/**
