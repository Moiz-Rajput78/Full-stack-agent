...
import type { ExtractorOnExtractedContext } from '../extractor.js';
...
export type SubconsciousDefaultCapture = (context: ExtractorOnExtractedContext<SubconsciousCaptureOutput>) => Promise<void>;
export type SubconsciousCaptureHook = (context: ExtractorOnExtractedContext<SubconsciousCaptureOutput> & {
...
export type SubconsciousObservationEntry = SubconsciousBuiltInObservationAgent | SubconsciousBuiltInObservationConfig | SubconsciousCustomObservationConfig;
export type SubconsciousReflectionEntry = SubconsciousBuiltInReflectionAgent | SubconsciousBuiltInReflectionConfig | SubconsciousCustomReflectionConfig;
