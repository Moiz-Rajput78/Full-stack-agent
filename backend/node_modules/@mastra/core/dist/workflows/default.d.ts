...
import type { DefaultEngineType, EntryExecutionResult, ExecutionContext, MutableContext, OutputWriter, RestartExecutionParams, SerializedStepFlowEntry, SingleStepEntry, StepExecutionResult, StepFlowEntry, StepResult, StepTripwireInfo, TimeTravelExecutionParams, WorkflowRunStatus } from './types.js';
...
export type ExecuteAgentParams = Omit<ExecuteStepParams, 'step'> & {
    entry: Extract<SingleStepEntry, {
        type: 'agent';
    }>;
};
export type ExecuteToolParams = Omit<ExecuteStepParams, 'step'> & {
    entry: Extract<SingleStepEntry, {
        type: 'tool';
    }>;
};
...
export declare class DefaultExecutionEngine extends ExecutionEngine {
     ...
     * recovery relies on.
     */
    protected lastPersistedStatusByRun: Map<string, WorkflowRunStatus>;
     ...
     */
    executeSleepDuration(duration: number, _sleepId: string, _workflowId: string, abortSignal?: AbortSignal): Promise<void>;
    /**
     ...
     * @param _workflowId - The workflow ID (for constructing platform-specific IDs)
     */
    executeSleepUntilDate(date: Date, _sleepUntilId: string, _workflowId: string, abortSignal?: AbortSignal): Promise<void>;
    /**
     ...
     */
    executeAgent(params: ExecuteAgentParams): Promise<StepExecutionResult>;
    /**
     ...
     * shared step runner.
     */
    executeTool(params: ExecuteToolParams): Promise<StepExecutionResult>;
    /**
     ...
     */
    executeMapping(params: ExecuteMappingParams): Promise<StepExecutionResult>;
