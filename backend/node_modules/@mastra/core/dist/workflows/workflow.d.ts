 ...
 */
export declare function predicateToCondition(predicate: Predicate): (params: any) => Promise<boolean>;
 ...
 */
type RequireAgentInput<TPrev> = [TPrev] extends [{
    prompt: string;
}] ? unknown : {
...
export declare class Workflow<TEngineType = DefaultEngineType, TSteps extends Step<string, any, any, any, any, any, TEngineType, any>[] = Step<string, unknown, unknown, unknown, unknown, unknown, TEngineType>[], TWorkflowId extends string = string, TState = unknown, TInput = unknown, TOutput = unknown, TPrevSchema = TInput, TRequestContext extends Record<string, any> | unknown = unknown> extends MastraBase implements Step<TWorkflowId, TState, TInput, TOutput | undefined, any, any, DefaultEngineType, TRequestContext> {
     ...
     */
    agent<TStepId extends string>(agent: (SubAgent<TStepId, any> | Agent<TStepId, any>) & RequireAgentInput<TPrevSchema>, options?: Omit<AgentStepOptions<{
        text: string;
    }>, 'structuredOutput'> & {
        structuredOutput?: never;
        retries?: number;
    ...
    agent<TStepId extends string, TStepOutput>(agent: (SubAgent<TStepId, any> | Agent<TStepId, any>) & RequireAgentInput<TPrevSchema>, options: Omit<AgentStepOptions<TStepOutput>, 'structuredOutput'> & {
        structuredOutput: {
            schema: StandardSchemaWithJSON<TStepOutput>;
        };
        retries?: number;
    ...
    agent(agentId: string, options?: AgentStepOptions<any> & {
        retries?: number;
        scorers?: DynamicArgument<MastraScorers>;
        metadata?: StepMetadata;
    }, stepOptions?: {
     ...
     */
    tool<TSchemaIn, TSchemaOut, TSuspend, TResume, TContext extends ToolExecutionContext<TSuspend, TResume, any>, TId extends string, TToolRC extends Record<string, any> | unknown = unknown>(tool: Tool<TPrevSchema extends TSchemaIn ? TSchemaIn : TPrevSchema, TSchemaOut, TSuspend, TResume, TContext, TId, TToolRC>, options?: {
        retries?: number;
        scorers?: DynamicArgument<MastraScorers>;
        metadata?: StepMetadata;
    }, stepOptions?: {
    ...
    execute({ runId, resourceId, inputData, resumeData, state, setState, suspend, restart, resume, timeTravel, [PUBSUB_SYMBOL]: pubsub, mastra, requestContext, abort, abortSignal, retryCount, outputWriter, validateInputs, perStep, actor, engine: _engine, bail: _bail, ...rest }: {
        runId?: string;
        resourceId?: string;
        inputData: TInput;
        resumeData?: unknown;
...
export declare class Run<TEngineType = DefaultEngineType, TSteps extends Step<string, any, any, any, any, any, TEngineType, any>[] = Step<string, unknown, unknown, unknown, unknown, unknown, TEngineType>[], TState = unknown, TInput = unknown, TOutput = unknown, TRequestContext extends Record<string, any> | unknown = unknown> {
    ...
    protected _start({ inputData, initialState, requestContext, outputWriter, tracingOptions, format, outputOptions, perStep, actor, ...rest }: (TInput extends unknown ? {
        inputData?: TInput;
    } : {
        inputData: TInput;
     ...
     * @returns A promise that resolves to the workflow output
     */
    streamLegacy({ inputData, requestContext, onChunk, tracingOptions, actor, ...rest }?: (TInput extends unknown ? {
        inputData?: TInput;
    } : {
        inputData: TInput;
    }) & {
     ...
     * @returns A promise that resolves to the workflow output
     */
    stream({ inputData, requestContext, tracingOptions, closeOnSuspend, initialState, outputOptions, perStep, actor, ...rest }: (TInput extends unknown ? {
        inputData?: TInput;
    } : {
        inputData: TInput;
    }) & (TState extends unknown ? {
     ...
     * @returns A promise that resolves to the workflow output
     */
    resumeStream<TResume>({ step, resumeData, requestContext, tracingOptions, forEachIndex, outputOptions, perStep, actor, ...rest }?: {
        resumeData?: TResume;
    ...
    protected _restart({ requestContext, outputWriter, tracingOptions, actor, ...rest }: {
        requestContext?: RequestContext<TRequestContext>;
        outputWriter?: OutputWriter;
        tracingOptions?: TracingOptions;
        actor?: ActorSignal;
    } & Partial<ObservabilityContext>): Promise<WorkflowResult<TState, TInput, TOutput, TSteps>>;
    protected _timeTravel<TInput>({ inputData, resumeData, initialState, step: stepParam, context, nestedStepsContext, requestContext, outputWriter, tracingOptions, outputOptions, perStep, actor, ...rest }: {
        inputData?: TInput;
        resumeData?: any;
        initialState?: TState;
    ...
    timeTravelStream<TTravelInput>({ inputData, resumeData, initialState, step, context, nestedStepsContext, requestContext, tracingOptions, outputOptions, perStep, actor, ...rest }: {
