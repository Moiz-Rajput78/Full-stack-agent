...
import { getEntryId } from './step-entry.js';
import type { ForeachConcurrencyContext, ForeachOptions, RestartExecutionParams, SingleStepEntry, StepFlowEntry, TimeTravelContext, TimeTravelExecutionParams, WorkflowRunState } from './types.js';
...
export declare function abortableSleep(duration: number, signal?: AbortSignal): Promise<void>;
 ...
 */
export declare function isSingleStepEntry(entry: StepFlowEntry): entry is SingleStepEntry;
/**
 ...
 */
export declare const getSingleStepEntryId: typeof getEntryId;
 ...
 */
export declare const assertTimeTravelGraphMatchesSnapshot: (params: {
    targetStepId: string;
 ...
 */
export declare function omitPriorSuspensionFields<T extends Record<string, unknown>>(stepInfo: T): Omit<T, 'suspendedAt' | 'suspendPayload' | 'suspendOutput'>;
export declare function omitPriorCompletionFields<T extends Record<string, unknown>>(stepInfo: T): Omit<T, 'output' | 'error' | 'endedAt' | 'suspendedAt' | 'suspendPayload' | 'suspendOutput' | 'tripwire' | 'nonRetryable'>;
/**
 ...
 */
export declare function resolveForeachConcurrency(opts: ForeachOptions | undefined, context: ForeachConcurrencyContext): number;
export declare function waitForSuspendedSnapshot(workflowsStore: {
    loadWorkflowSnapshot: (args: {
        workflowName: string;
        runId: string;
    }) => Promise<WorkflowRunState | null>;
} | undefined, workflowName: string, runId: string): Promise<WorkflowRunState | null>;
