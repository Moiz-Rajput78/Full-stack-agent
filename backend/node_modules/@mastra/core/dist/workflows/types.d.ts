...
export type StepEntry = Extract<SingleStepEntry, {
    type: 'step';
}>;
/** The `{ type: 'agent' }` variant of {@link SingleStepEntry}. */
export type AgentStepEntry = Extract<SingleStepEntry, {
    type: 'agent';
}>;
/** The `{ type: 'tool' }` variant of {@link SingleStepEntry}. */
export type ToolStepEntry = Extract<SingleStepEntry, {
    type: 'tool';
}>;
/** The `{ type: 'mapping' }` variant of {@link SingleStepEntry}. */
export type MappingStepEntry<TEngineType = DefaultEngineType> = Extract<SingleStepEntry<TEngineType>, {
    type: 'mapping';
}>;
export type StepFlowEntry<TEngineType = DefaultEngineType> = SingleStepEntry<TEngineType> | {
    type: 'sleep';
    id: string;
    duration?: number;
...
export type SerializedStepFlowEntry = SerializedSingleStepEntry | {
    type: 'sleep';
    id: string;
    duration?: number;
    fn?: string;
