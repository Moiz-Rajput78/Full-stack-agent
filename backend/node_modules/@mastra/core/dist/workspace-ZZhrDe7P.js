...
const executeCommandInputSchema = z.object({
	...
	tail: z.preprocess(coerceNumericString, z.number()).nullish().describe(`For foreground commands: limit output to the last N lines, similar to tail -n. Defaults to 200. Use 0 for no limit.`)
});
...
Use this after starting a background command with execute_command (background: true) to check if the process is still running and read its output.`,
	...
	inputSchema: z.object({
		...
		tail: z.preprocess(coerceNumericString, z.number()).optional().describe(`Number of lines to return, similar to tail -n. Positive or negative returns last N lines from end. Defaults to 200. Use 0 for no limit.`),
...
//#endregion
export { detectIsolation as A, MountError as B, formatSkillActivation as C, VersionedSkillSource as D, CompositeVersionedSkillSource as E, SandboxProcessManager as F, SandboxTimeoutError as G, SandboxError as H, ProcessHandle as I, CompositeFilesystem as J, LocalFilesystem as K, UnsupportedStdinCloseError as L, isIsolationAvailable as M, MastraSandbox as N, BM25Index as O, MountManager as P, FilesystemNotMountableError as R, createSkillTools as S, publishSkillFromSource as T, SandboxExecutionError as U, MountNotSupportedError as V, SandboxNotReadyError as W, pMap as X, callLifecycle as Y, requireWorkspace as _, readFileTool as a, supportsNetworking as b, indexContentTool as c, BrowserCliHandler as d, browserCliHandler as f, requireSandbox as g, requireFilesystem as h, searchTool as i, getRecommendedIsolation as j, LocalSandbox as k, fileStatTool as l, deleteFileTool as m, resolveToolConfig as n, mkdirTool as o, editFileTool as p, MastraFilesystem as q, writeFileTool as r, listFilesTool as s, createWorkspaceTools as t, executeCommandTool as u, WORKSPACE_TOOLS as v, collectSkillForPublish as w, Workspace as x, WORKSPACE_TOOLS_PREFIX as y, IsolationUnavailableError as z };

//# sourceMappingURL=workspace-ZZhrDe7P.js.map