...
var SkillsStorage = class extends require_filesystem_versioned.VersionedStorageDomain {
	listKey = "skills";
	...
	async update(input) {
		...
		if (hasConfigUpdate) {
			...
			if (changedFields.length > 0) {
				const newVersionId = (0, crypto$1.randomUUID)();
...
Object.defineProperty(exports, "skillSnapshotFieldValuesEqual", {
	enumerable: true,
	get: function() {
		return skillSnapshotFieldValuesEqual;
	}
});

//# sourceMappingURL=filesystem-CIf60Kfg.cjs.map