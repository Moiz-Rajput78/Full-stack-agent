...
*/
function matchesExpectedWorkflowStatus(currentStatus, expectedStatus) {
	if (expectedStatus === void 0) return true;
	return currentStatus !== void 0 && (Array.isArray(expectedStatus) ? expectedStatus : [expectedStatus]).includes(currentStatus);
}
