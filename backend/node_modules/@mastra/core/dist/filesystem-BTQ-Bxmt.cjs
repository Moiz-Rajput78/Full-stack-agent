...
var MCPServersStorage = class extends require_filesystem_versioned.VersionedStorageDomain {
	listKey = "mcpServers";
...
Object.defineProperty(exports, "MCPServersStorage", {
	enumerable: true,
	get: function() {
		return MCPServersStorage;
	}
});

//# sourceMappingURL=filesystem-BTQ-Bxmt.cjs.map