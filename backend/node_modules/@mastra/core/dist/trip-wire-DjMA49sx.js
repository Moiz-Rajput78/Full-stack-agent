...
import { d as readModelStreamTransport, i as resolveModelConfig, u as attachModelStreamTransport } from "./llm-DvWMvobp.js";
...
import { a as coreContentToString, n as MessageList, o as messagesAreEqual, t as convertMessages } from "./message-list-5lTnL-Q8.js";
	...
	constructor({ model: _model, stream, messageList, options, messageId, initialState }) {
		...
		if (processorRunner && options.isLLMExecutionStep) {
			...
			processedStream = stream.pipeThrough(new TransformStream({ async transform(chunk, controller) {
				const isDeferredErrorChunk = options.deferErrorChunks && (chunk.type === "error" || chunk.type === "finish" && chunk.payload?.stepResult?.reason === "error");
				if (chunk.type === "finish" && chunk.payload?.stepResult?.reason === "tool-calls" || isDeferredErrorChunk) {
					controller.enqueue(chunk);
					return;
				} else {
					/**
...
//# sourceMappingURL=trip-wire-DjMA49sx.js.map