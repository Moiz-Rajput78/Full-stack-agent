...
import type { KnowledgeActivityEvent, KnowledgeCurationCursor, KnowledgeRecord, KnowledgeNode, KnowledgeSemanticOutboxEntry } from './knowledge/index.js';
...
import type { WorkflowDefinition } from './workflow-definitions/index.js';
...
export declare class InMemoryDB {
    ...
    readonly traceCursorIds: Map<string, number>;
    readonly branchCursorIds: Map<string, number>;
    readonly metricCursorIds: Map<{
    ...
    readonly feedbackCursorIds: Map<{
        timestamp: Date;
        feedbackType: string;
        value: string | number;
     ...
     */
    readonly favorites: Map<string, StorageFavoriteType>;
    ...
    readonly knowledgeNodes: Map<string, KnowledgeNode>;
    readonly knowledgeNodeKeys: Map<string, string>;
    readonly knowledgeRecords: Map<string, KnowledgeRecord>;
    readonly knowledgeMentions: Map<string, Set<string>>;
    readonly knowledgeCursors: Map<string, KnowledgeCurationCursor>;
    readonly knowledgeActivity: KnowledgeActivityEvent[];
    readonly knowledgeSemanticOutbox: Map<string, KnowledgeSemanticOutboxEntry>;
    readonly knowledgeSemanticIdempotency: Map<string, string>;
     ...
     */
    readonly toolProviderConnections: Map<string, StorageToolProviderConnection>;
    /**
