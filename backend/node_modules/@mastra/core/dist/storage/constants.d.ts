...
export declare const TABLE_WORKFLOW_DEFINITIONS = "mastra_workflow_definitions";
...
export declare const WORKFLOW_DEFINITIONS_SCHEMA: Record<string, StorageColumn>;
...
export declare const KNOWLEDGE_NODES_SCHEMA: Record<string, StorageColumn>;
export declare const KNOWLEDGE_RECORDS_SCHEMA: Record<string, StorageColumn>;
export declare const KNOWLEDGE_MENTIONS_SCHEMA: Record<string, StorageColumn>;
export declare const KNOWLEDGE_CURSORS_SCHEMA: Record<string, StorageColumn>;
export declare const KNOWLEDGE_ACTIVITY_SCHEMA: Record<string, StorageColumn>;
export declare const KNOWLEDGE_SEMANTIC_OUTBOX_SCHEMA: Record<string, StorageColumn>;
/**
