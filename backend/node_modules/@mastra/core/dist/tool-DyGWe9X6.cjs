...
function getRequestContextInputValidator(schema) {
	const standardSchema = (0, _mastra_schema_compat_schema.toStandardSchema)(schema);
	return (values) => {
		try {
...
*/
var TransformedRequestContext = class extends require_request_context.RequestContext {
	#source;
	#acceptsInput;
	#encode;
	...
	constructor(opts) {
		...
		if (opts.execute) {
			...
			this.execute = async (inputData, context) => {
				...
				const executionRequestContext = this.requestContextSchema ? new TransformedRequestContext(sourceRequestContext ?? new require_request_context.RequestContext(), validatedRequestContext, getRequestContextInputValidator(this.requestContextSchema), getRequestContextEncoder(this.requestContextSchema)) : context?.requestContext;
				...
				if (!context) organizedContext = {
					requestContext: executionRequestContext ?? new require_request_context.RequestContext(),
					mastra: void 0
				};
				else {
...
Object.defineProperty(exports, "getRequestContextInputValues", {
	enumerable: true,
	get: function() {
		return getRequestContextInputValues;
	}
});
...
Object.defineProperty(exports, "markBuilderValidatedInput", {
	enumerable: true,
	get: function() {
		return markBuilderValidatedInput;
	}
});
...
//# sourceMappingURL=tool-DyGWe9X6.cjs.map