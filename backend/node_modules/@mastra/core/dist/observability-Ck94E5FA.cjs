...
function startRagIngestion(options) {
	const span = require_utils.getOrCreateSpan({
		...options,
		entityType: require_utils.EntityType.RAG_INGESTION,
		type: "rag_ingestion"
	});
	return {
		span,
...
//# sourceMappingURL=observability-Ck94E5FA.cjs.map