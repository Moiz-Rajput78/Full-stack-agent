...
function contentsToSignalParts(contents) {
	...
	return contents.map((part) => {
		if (part.type === "file") return {
			type: "file",
			data: part.data instanceof URL ? part.data.toString() : require_data_content.convertDataContentToBase64String(part.data),
...
//# sourceMappingURL=signals-zuUbXoDr.cjs.map