...
import { type NotificationDeliveryPolicyInput } from '../notifications/delivery-policy.js';
import type { NotificationDeliveryDecision, SendNotificationSignalInput } from '../notifications/types.js';
...
import type { DeclaredAgentSchedule } from '../schedules/define.js';
...
import type { ChunkType, MastraAgentNetworkStream, MastraOnFinishCallback } from '../stream/index.js';
...
import type { DurableAgentListActiveRunsOptions, DurableAgentListActiveRunsResult, DurableAgentRecoverActiveRunsOptions, DurableAgentRecoverActiveRunsResult, DurableAgentRecoverOptions, DurableAgentStreamOptions, DurableAgentStreamResult } from './durable/durable-agent.js';
import type { AgentStepFinishEventData, AgentSuspendedEventData } from './durable/types.js';
 ...
 * ```
 */
export declare class Agent<TAgentId extends string = string, TTools extends ToolsInput = ToolsInput, TOutput = undefined, 
/**
 ...
 */
TRequestContext extends Record<string, any> | unknown = any, TEditor extends AgentEditorConfig | undefined = AgentEditorConfig | undefined> extends MastraBase implements SubAgent<TAgentId, TRequestContext> {
    #private;
    id: TAgentId;
    name: string;
     ...
     */
    __setDeclaredSchedules(schedules: DeclaredAgentSchedule[]): void;
    /**
     ...
     */
    getDeclaredSchedules(): DeclaredAgentSchedule[];
    /**
     ...
     * ```
     */
    listTools({ requestContext, resolveWebSearch, }?: {
        requestContext?: RequestContext;
        resolveWebSearch?: boolean;
    }): Promise<TTools>;
    /**
     ...
     * @internal
     */
    __markStoredVersionApplied(): void;
    /**
     ...
     */
    filterUiMessagesByThread<T extends {
        id: string;
    }>(messageList: MessageList, threadId: string, uiMessages: T[]): T[];
     ...
     */
    protected requireAgentExecutionFGA({ requestContext, memory, runId, snapshotMemoryInfo, actor, }: {
        requestContext?: RequestContext;
    ...
    resume(runId: string, resumeData: unknown, options?: DurableAgentStreamOptions<TOutput>): Promise<DurableAgentStreamResult<TOutput>>;
    ...
    prepare(messages: MessageListInput, options?: AgentExecutionOptions<TOutput>): Promise<unknown>;
}
export {};
