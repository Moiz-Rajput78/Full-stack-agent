...
const require_utils = require("./utils-bTzvflT5.cjs");
...
const require_workflow_event_processor = require("./workflow-event-processor-BZwyoOWv.cjs");
const require_hooks = require("./hooks-JAto1d0E.cjs");
const require_storage = require("./storage-CyPQO-22.cjs");
const require_source = require("./source-CAzSWaGQ.cjs");
const require_storage$1 = require("./storage-CQwCzQE9.cjs");
const require_create_durable_agent = require("./create-durable-agent-Cpema5mO.cjs");
const require_manager = require("./manager-CpOlaOwT.cjs");
...
const require_tool_loop_agent = require("./tool-loop-agent-BdB9kiPw.cjs");
const require_worker = require("./worker-CsClAEgM.cjs");
const require_builder = require("./builder-DZ8IJde1.cjs");
const require_validate = require("./validate-eMiRyLc7.cjs");
const require_rehydrate = require("./rehydrate-Ubtaj0dD.cjs");
	...
	*/
	#syncGatewayRegistry() {
		try {
			...
			Promise.resolve().then(() => require("./provider-registry-CGdjWbt5.cjs")).then((n) => n.provider_registry_exports).then(async ({ GatewayRegistry }) => {
...
//# sourceMappingURL=mastra-CcIWDZOD.cjs.map