...
import { c as MastraModelGateway, i as MASTRA_USER_AGENT, o as createAnthropic, r as GATEWAY_AUTH_HEADER } from "./dist-BcUqNSEb.js";
import { a as getCapabilityFileName, i as shouldEnableGateway, n as getGatewayId } from "./gateway-helpers-Dh-2ojNA.js";
import { i as createOpenRouter, t as ModelsDevGateway } from "./models-dev-CXAIJO1e.js";
import { t as NetlifyGateway } from "./netlify-BmFfDnkR.js";
	...
	providers: {
		...
		"opencode-go": {
			...
			"modelOverrides": {
				...
				"muse-spark-1.2-contributor": { "npm": "@ai-sdk/openai" }
			},
			"deprecatedModels": [
				"glm-5",
				"kimi-k2.5",
		...
		"echo": {
			...
			"apiKeyEnvVar": "ECHO_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "Echo",
			"models": ["echo"],
			"docUrl": "https://echo.tracerml.ai/docs/api",
			"gateway": "models.dev"
		},
		"cloudferro-sherlock": {
		...
		"opencode": {
			...
			"modelOverrides": {
				...
				"muse-spark-1.2-contributor-free": { "npm": "@ai-sdk/openai" },
...
var GatewayRegistry = class GatewayRegistry {
	...
	*/
	async syncGateways(forceRefresh = false, writeToSrc = false) {
		...
		try {
			const { ModelsDevGateway } = await import("./models-dev-CXAIJO1e.js").then((n) => n.n);
			const { NetlifyGateway } = await import("./netlify-BmFfDnkR.js").then((n) => n.n);
...
//# sourceMappingURL=provider-registry-Dl1vIDdY.js.map