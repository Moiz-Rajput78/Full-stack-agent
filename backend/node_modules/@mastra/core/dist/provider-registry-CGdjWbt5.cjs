...
const require_dist = require("./dist-i91YpPeb.cjs");
const require_gateway_helpers = require("./gateway-helpers-B_IPtGRQ.cjs");
const require_models_dev = require("./models-dev-BGJkuh-B.cjs");
const require_netlify = require("./netlify-Bx4u8950.cjs");
let os = require("os");
...
var GatewayRegistry = class GatewayRegistry {
	...
	*/
	async syncGateways(forceRefresh = false, writeToSrc = false) {
		...
		try {
			const { ModelsDevGateway } = await Promise.resolve().then(() => require("./models-dev-BGJkuh-B.cjs")).then((n) => n.models_dev_exports);
			const { NetlifyGateway } = await Promise.resolve().then(() => require("./netlify-Bx4u8950.cjs")).then((n) => n.netlify_exports);
...
//# sourceMappingURL=provider-registry-CGdjWbt5.cjs.map