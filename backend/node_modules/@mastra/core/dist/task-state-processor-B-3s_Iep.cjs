...
var GoalStateProcessor = class {
	...
	async computeStateSignal(args) {
		...
		else if (cached?.objective) current = cached.objective;
		else {
...
const taskIdSchema = zod_v4.z.string().min(1).describe("Stable task identifier (for example, 'task_investigate_tests'). Keep this unchanged across updates.");
const taskItemInputSchema = zod_v4.z.object({
	id: taskIdSchema.optional(),
	content: zod_v4.z.string().min(1).describe("Task description in imperative form (e.g., 'Fix authentication bug')"),
	status: zod_v4.z.enum([
		"pending",
		"in_progress",
		"completed"
	]).describe("Current task status"),
	activeForm: zod_v4.z.string().min(1).describe("Present continuous form shown during execution (e.g., 'Fixing authentication bug')")
});
const taskItemSchema = taskItemInputSchema.extend({ id: taskIdSchema });
const taskToolResultSchema = zod_v4.z.object({
	content: zod_v4.z.string(),
	tasks: zod_v4.z.array(taskItemSchema),
	isError: zod_v4.z.boolean()
});
const taskCheckSummarySchema = zod_v4.z.object({
	total: zod_v4.z.number().int().nonnegative(),
	completed: zod_v4.z.number().int().nonnegative(),
	inProgress: zod_v4.z.number().int().nonnegative(),
	pending: zod_v4.z.number().int().nonnegative(),
	incomplete: zod_v4.z.number().int().nonnegative(),
	hasTasks: zod_v4.z.boolean(),
	allCompleted: zod_v4.z.boolean()
});
const taskCheckResultSchema = taskToolResultSchema.extend({
	summary: taskCheckSummarySchema,
	incompleteTasks: zod_v4.z.array(taskItemSchema)
});
...
*/
const taskWriteTool = require_tool.createTool({
	id: "task_write",
...
- completed: Finished successfully`,
	inputSchema: zod_v4.z.object({ tasks: zod_v4.z.array(taskItemInputSchema).describe("The complete updated task list") }),
...
*/
const taskUpdateTool = require_tool.createTool({
	id: "task_update",
...
- If the ID is unknown, the tool returns an error with available task IDs`,
	inputSchema: zod_v4.z.object({
		id: taskIdSchema,
		content: zod_v4.z.string().min(1).optional().describe("New task description in imperative form"),
		status: zod_v4.z.enum([
			"pending",
			"in_progress",
			"completed"
		]).optional().describe("New task status"),
		activeForm: zod_v4.z.string().min(1).optional().describe("New present continuous form shown during execution")
...
*/
const taskCompleteTool = require_tool.createTool({
	id: "task_complete",
...
- Provide the task ID returned by the task-list tools
- If the ID is unknown, the tool returns an error with available task IDs`,
	inputSchema: zod_v4.z.object({ id: taskIdSchema }),
	outputSchema: taskToolResultSchema,
...
*/
const taskCheckTool = require_tool.createTool({
	id: "task_check",
...
//#endregion
Object.defineProperty(exports, "DEFAULT_GOAL_JUDGE_PROMPT", {
	enumerable: true,
	get: function() {
		return DEFAULT_GOAL_JUDGE_PROMPT;
	}
});
Object.defineProperty(exports, "DEFAULT_GOAL_MAX_RUNS", {
	enumerable: true,
	get: function() {
		return DEFAULT_GOAL_MAX_RUNS;
	}
});
Object.defineProperty(exports, "GOAL_SCORER_ID", {
	enumerable: true,
	get: function() {
		return GOAL_SCORER_ID;
	}
});
Object.defineProperty(exports, "GOAL_SCORE_WAITING", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "TASKS_REQUEST_CONTEXT_KEY", {
	enumerable: true,
	get: function() {
		return TASKS_REQUEST_CONTEXT_KEY;
	}
});
Object.defineProperty(exports, "TASKS_STATE_ID", {
	enumerable: true,
	get: function() {
		return TASKS_STATE_ID;
	}
});
...
Object.defineProperty(exports, "assignTaskIds", {
	enumerable: true,
	get: function() {
		return assignTaskIds;
	}
});
Object.defineProperty(exports, "cacheGoalObjective", {
	enumerable: true,
	get: function() {
		return cacheGoalObjective;
	}
});
Object.defineProperty(exports, "clearCachedGoalObjective", {
	enumerable: true,
	get: function() {
		return clearCachedGoalObjective;
	}
});
...
//# sourceMappingURL=task-state-processor-B-3s_Iep.cjs.map