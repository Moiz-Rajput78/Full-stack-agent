...
var GoalSignalProvider = class extends SignalProvider {
	id = "goal-signals";
	#processor = new require_task_state_processor.GoalStateProcessor();
	getInputProcessors() {
...
//# sourceMappingURL=signal-provider-CkKyHtAI.cjs.map