 ...
 */
export declare function experimentScoreId(experimentId: string, itemId: string, attempt: number, scorerId: string): string;
/** Prefix shared by all scores of one (experiment, item, attempt) execution. */
export declare function experimentScoreKey(experimentId: string, itemId: string, attempt: number): string;
export declare function runScorersForItem(scorers: MastraScorer<any, any, any, any>[], item: {
    input: unknown;
    groundTruth?: unknown;
    metadata?: Record<string, unknown>;
}, output: unknown, storage: MastraCompositeStore | null, runId: string, targetType: TargetType, targetId: string, itemId: string, scorerInput?: ScorerRunInputForAgent, scorerOutput?: ScorerRunOutputForAgent, traceId?: string, workflowData?: WorkflowScorerData, persistScores?: boolean, stableScoreKey?: string): Promise<ScorerResult[]>;
/**
