	...
	*/
	async resolveTools(toolSlugs, toolConfigs, options) {
		return this.resolveToolsVNext({
			...
			requestContext: options?.requestContext ? new require_request_context.RequestContext(Object.entries(options.requestContext)) : void 0
		});
	}
	/**
...
function resolveCallerSuppliedAuthorId(requestContext, logger) {
	const resourceId = requestContext?.getRaw(require_request_context.MASTRA_RESOURCE_ID_KEY);
