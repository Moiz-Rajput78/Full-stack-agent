	...
	*/
	async resolveTools(toolSlugs, toolConfigs, options) {
		return this.resolveToolsVNext({
			...
			requestContext: options?.requestContext ? new RequestContext(Object.entries(options.requestContext)) : void 0
		});
	}
	/**
