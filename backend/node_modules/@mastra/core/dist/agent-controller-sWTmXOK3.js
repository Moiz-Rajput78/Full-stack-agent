...
import { a as ModelRouterLanguageModel, c as defaultGateways, o as GatewayManager } from "./llm-DvWMvobp.js";
import { r as createTool } from "./tool-BwroCWv4.js";
import { toStandardSchema } from "./schema/index.js";
import { safeStringify } from "./utils/safe-stringify.js";
import { X as CHAT_CHANNEL_RENDER_CONTEXT_KEY, p as getServerSideFallbackInfo, t as Agent } from "./agent-DSxJoGjY.js";
import { n as hasTransformedToolPayload, t as getTransformedToolPayload } from "./payload-transform-C4k4-WlM.js";
import { c as resolveDeliveryAttributes, n as createSignal } from "./signals-wX3sXZ79.js";
...
import { s as askUserTool, t as submitPlanTool } from "./tools-JTnE07Fb.js";
import { t as AgentControllerChannels } from "./channels-BpFMz0mz.js";
import { t as Mastra } from "./mastra-Bn5mWcPE.js";
...
var SessionModel = class {
	...
	*/
	async syncFromPersisted({ modeId }) {
...
function asInterjection(signal) {
	if (signal.type !== "user" || signal.attributes?.delivery !== void 0) return signal;
...
var Session = class {
	...
	*/
	sendSignal(input, options) {
		...
		const submittedWhileWorking = submittedIsRunning || submittedAbortRequested && Boolean(submittedRunId || submittedActiveRunId);
		const submitted = createSignal("content" in input ? {
			type: "user",
			tagName: "user",
...
//# sourceMappingURL=agent-controller-sWTmXOK3.js.map