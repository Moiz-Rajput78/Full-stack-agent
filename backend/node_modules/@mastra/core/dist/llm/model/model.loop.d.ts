...
export declare class MastraLLMVNext extends MastraBase {
    ...
    stream<Tools extends ToolSet, OUTPUT = undefined>({ resumeContext, runId, stopWhen, maxSteps, tools, modelSettings, toolChoice, threadId, resourceId, structuredOutput, options, inputProcessors, llmRequestInputProcessors, outputProcessors, errorProcessors, returnScorerData, providerOptions, messageList, requireToolApproval, toolCallConcurrency, _internal, agentId, agentName, toolCallId, requestContext, actor, mcp, methodType, includeRawChunks, experimentalTransform, autoResumeSuspendedTools, maxProcessorRetries, processorStates, activeTools, isTaskComplete, goal, onIterationComplete, workspace, ...rest }: ModelLoopStreamArgs<Tools, OUTPUT>): MastraModelOutput<OUTPUT>;
}
