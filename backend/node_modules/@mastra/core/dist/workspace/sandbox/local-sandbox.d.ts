...
import type { SandboxCloneOptions } from './sandbox.js';
...
export declare class LocalSandbox extends MastraSandbox {
     ...
     */
    private _customSeatbeltProfile?;
