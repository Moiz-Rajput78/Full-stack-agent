...
- [**OpenAI**](https://mastra.ai/integrations/voice/openai): High-accuracy transcription with Whisper models
- [**Azure**](https://mastra.ai/integrations/voice/azure): Microsoft's speech recognition with enterprise-grade reliability
