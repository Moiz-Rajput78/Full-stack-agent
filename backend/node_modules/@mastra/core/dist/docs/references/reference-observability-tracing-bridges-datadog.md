...
See the [DatadogBridge Guide](https://mastra.ai/integrations/observability/datadog) for complete setup instructions, including dd-trace initialization, bundler externals, and agent configuration.
...
- [DatadogBridge Guide](https://mastra.ai/integrations/observability/datadog) - Setup guide with examples
